...
public class CestaBasicaBuilder implements ICestaBuilder {
	...
	public CestaBasicaBuilder() {
		...
		cesta.setTipoCesta( TipoCestaEnum.CESTA_BASICA );
	}
	...
	public void adicionarOrigemAnimal() {
		itensPedido.add( new ItemPedido( ProdutoDAO.getInstance().buscaProdutoPorId( 29 ), 1 ) );
	...
	public void adicionarIndustrializados() {
		...
		itensPedido.add( new ItemPedido( ProdutoDAO.getInstance().buscaProdutoPorId( 24 ), 1 ) );
		itensPedido.add( new ItemPedido( ProdutoDAO.getInstance().buscaProdutoPorId( 26 ), 1 ) );
		itensPedido.add( new ItemPedido( ProdutoDAO.getInstance().buscaProdutoPorId( 27 ), 1 ) );
		cesta.setItensPedido( itensPedido );
	}
